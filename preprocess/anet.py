...
input_folders = ['data/anet/v1-2/val', 'data/anet/v1-2/train', 'data/anet/v1-2/test', 'data/anet/v1-3/train_val', 'data/anet/v1-3/test']
output_folder = 'data/anet/videos_0.5FPS_number_red_40_br'
